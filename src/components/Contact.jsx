...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "f047bb49-e545-4484-a9c3-a6384baa918b");
  ...
  return (
    ...
    className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden' id='Contact'>
      ...
      <p className='text-center text-gray mb-12 max-w-80 mx-auto'>Ready to Make a Move? Let's Build Your Future Together</p>
